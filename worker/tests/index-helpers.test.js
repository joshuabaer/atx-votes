...
describe("Route patterns — additional coverage", () => {
  it("has vanity tone entry points /cowboy and /chef", () => {
    expect(indexSrc).toContain('url.pathname === "/cowboy"');
    expect(indexSrc).toContain('url.pathname === "/chef"');
...
describe("Candidate profile page", () => {
  ...
  it("includes OG meta tags for social sharing", () => {
    ...
    expect(profileBlock).toContain("og:title");
    expect(profileBlock).toContain("og:description");
    expect(profileBlock).toContain("og:type");
    expect(profileBlock).toContain("og:image");
  });
...
describe("Tone generation", () => {
  it("defines VALID_TONES as [1, 3, 4, 6, 7]", () => {
    expect(indexSrc).toContain("VALID_TONES = [1, 3, 4, 6, 7]");
  });
  ...
  it("has tone labels for all valid tones", () => {
    ...
    expect(indexSrc).toContain("Swedish Chef");
